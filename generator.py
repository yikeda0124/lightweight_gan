...
class Generator(nn.Module):
    ...
    def __init__(self, latent_dim=256):
        ...
        self.from4to8 = UpSampleConv(1024, 512).upsample_conv
        self.from8to16 = UpSampleConv(512, 256).upsample_conv
        self.from16to32 = UpSampleConv(256, 128).upsample_conv
        self.from32to64 = UpSampleConv(128, 128).upsample_conv
        self.from64to128 = UpSampleConv(128, 64).upsample_conv
        self.from128to256 = UpSampleConv(64, 32).upsample_conv
        self.from256to512 = UpSampleConv(32, 16).upsample_conv
        self.from512to1024 = UpSampleConv(16, 8).upsample_conv
        
        self.sle128 = SkipLayerExcitation(512, 64)
        self.sle256 = SkipLayerExcitation(256, 32)
        self.sle512 = SkipLayerExcitation(128, 16)
        
        self.toimg1024 = FinalConv(8).final_conv
        
    def forward(self, input_img):
        img4 = self.initial_conv(input_img)
